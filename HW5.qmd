...
In this notebook I will combine the materials from all 5 sessions of class to create a complete analysis of a data set. I will use the "sleep duration" data set that compares sleep duration to having a tv in one's bedroom and smartphone use before bed for teenagers.
